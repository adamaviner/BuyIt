package com.adam.BuyIt.database;
...
import com.adam.BuyIt.ShoppingListActivity;
import com.adam.BuyIt.R;
...
public class ShopDatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadWords() throws IOException {
        Log.d(ShoppingListActivity.TAG, "Loading foods from text...");
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (!wasAdded) {
                    Log.e(ShoppingListActivity.TAG, "unable to add product: " + name);
                }
            }
        } finally {
            reader.close();
        }
        Log.d(ShoppingListActivity.TAG, "DONE loading products.");
    }
