...
import com.adam.BuyIt.database.ProductAdapter;
import com.adam.BuyIt.database.ProductAdapter.Holder;
import com.adam.BuyIt.database.ProductTable;
import com.adam.BuyIt.database.ShopContentProvider;
import com.fortysevendeg.android.swipelistview.BaseSwipeListViewListener;
import com.fortysevendeg.android.swipelistview.SwipeListView;

public class ShoppingListActivity extends ListActivity implements LoaderCallbacks<Cursor> {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        if (isGridView) setContentView(R.layout.activity_shopping_list);
